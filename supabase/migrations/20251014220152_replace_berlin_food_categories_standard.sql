/*
  # Replace Berlin Food Categories with Standard Structure
  
  Replace with standard 6 categories: Hamburger, Pizza, Kahve, Kafe, Michelin, Yerel Lezzetler
*/
...
DECLARE
  v_city_id uuid;
BEGIN
  SELECT id INTO v_city_id FROM cities WHERE slug = 'berlin';
  ...
  (v_city_id, 'Berlin''e Özel Lezzetler', 'yerel-lezzetler', 'Grape', 6);
